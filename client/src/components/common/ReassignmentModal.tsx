      ...
      <div className="bg-white border border-red-300 rounded-2xl max-w-3xl w-full shadow-2xl overflow-hidden animate-fade-in">
        ...
        <div className="bg-red-50 border-b border-red-200 px-6 py-4 flex items-center justify-between">
          <div className="flex items-center space-x-3">
            <div className="p-2 rounded-lg bg-rose-500/20 text-red-600 border border-red-300">
        ...
        <div className="bg-slate-50 px-6 py-4 border-t border-slate-200 flex items-center justify-between">
          ...
          <div className="flex items-center space-x-3">
            ...
            <button
              ...
              className="px-5 py-2 rounded-lg bg-emerald-600 hover:bg-emerald-500 text-white text-xs font-bold flex items-center space-x-2 transition disabled:opacity-50"
            >
              {submitting ? (
              ...
              <span>Approve Dynamic Reassignment to {recommendation.bestDockId}</span>
            </button>
          </div>
        </div>
      </div>
